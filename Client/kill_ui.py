# Form implementation generated from reading ui file 'kill.ui'
#
...
class Ui_Dialog_Kill(object):
    def setupUi(self, Dialog_Kill):
        ...
        self.layoutWidget = QtWidgets.QWidget(parent=Dialog_Kill)
        ...
        self.btn_kill = QtWidgets.QPushButton(parent=self.layoutWidget)
    ...
    def retranslateUi(self, Dialog_Kill):
        ...
        Dialog_Kill.setWindowTitle(_translate("Dialog_Kill", "Dialog"))
...
if __name__ == "__main__":
    ...
    Dialog_Kill = QtWidgets.QDialog()
    ui = Ui_Dialog_Kill()
    ui.setupUi(Dialog_Kill)
    Dialog_Kill.show()
    sys.exit(app.exec())
